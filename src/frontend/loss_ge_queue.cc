...
LossQueue::LossQueue()
    : g2b_prng_( random_device()() ),
    b2g_prng_( random_device()() ),
    good_state_prng_( random_device()() ),
    bad_state_prng_( random_device()() ),
    is_good_state(true)
{}
...
{
    if(is_good_state){
        is_good_state = g2b_dist_( g2b_prng_ );
        return good_state_drop_dist_( good_state_prng_ );
    }
    else{
        is_good_state = b2g_dist_( b2g_prng_ );
        return bad_state_drop_dist_( bad_state_prng_ );
    }
}
