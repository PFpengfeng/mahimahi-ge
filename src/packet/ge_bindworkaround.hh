...
#ifndef GE_BIND_WORKAROUND_HH
#define GE_BIND_WORKAROUND_HH
...
namespace BindWorkAround
{
    ...
    private:
        ...
        {
            return Object( std::move( std::get<0>( bound_arguments_ ) ),
                    std::move( std::get<1>( bound_arguments_ )),
                    std::move( std::get<2>( bound_arguments_ )),
                    std::move( std::get<3>( bound_arguments_ )),
                    );
        }
